...
const PT: Dict = {
 ...
 "theme.sunset": "Pôr do sol",
  ...
  "landing.hero.badge": "Tudo para sua rotina",
  "landing.hero.title1": "Sua rotina,",
  "landing.hero.title2": "em harmonia",
  "landing.hero.sub": "Calendário menstrual, agenda, gerenciador de tarefas, cronograma capilar e rotina de skin care - organizados em um só lugar",
...
const EN: Dict = {
 ...
 "theme.sunset": "Sunset",
  ...
  "landing.hero.badge": "Everything for your routine",
  "landing.hero.title1": "Your routine,",
  "landing.hero.title2": "in harmony",
  "landing.hero.sub": "Menstrual calendar, agenda, task manager, hair schedule and skin care routine — all in one place",
