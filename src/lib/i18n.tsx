...
const PT: Dict = {
 ...
 "theme.sunset": "Pôr do sol",
  ...
  "landing.hero.badge": "Tudo o que sua rotina feminina precisa",
  "landing.hero.title1": "Sua rotina,",
  "landing.hero.title2": "em harmonia",
  "landing.hero.sub": "Ciclo menstrual, agenda, tarefas, cronograma capilar e skin care — organizados em um só lugar, com privacidade total.",
  "landing.mod.cycle.t": "Ciclo & Diário",
  "landing.mod.cycle.d": "Calendário com fases, previsões e registro de sintomas.",
  "landing.mod.agenda.t": "Agenda",
  "landing.mod.agenda.d": "Compromissos com data, hora e local.",
  "landing.mod.tasks.t": "Tarefas",
  "landing.mod.tasks.d": "Lista com prioridades e prazos.",
  "landing.mod.hair.t": "Cronograma capilar",
  "landing.mod.hair.d": "Hidratação, nutrição e reconstrução no ritmo certo.",
  "landing.mod.skincare.t": "Skin care",
  "landing.mod.skincare.d": "Rotina AM e PM com check-in diário.",
  "landing.mod.privacy.t": "Privacidade",
  "landing.mod.privacy.d": "Seus dados só acessíveis por você.",
  "landing.steps.title": "Como funciona",
  "landing.step1.t": "Crie sua conta",
  "landing.step1.d": "Em segundos, com e-mail ou Google.",
  "landing.step2.t": "Conte seu ritmo",
  "landing.step2.d": "Algumas perguntas iniciais sobre seu ciclo.",
  "landing.step3.t": "Use os botões",
  "landing.step3.d": "Cada área da sua rotina em um toque.",
  "landing.final.title": "Comece a organizar sua rotina hoje",
};
...
const EN: Dict = {
 ...
 "theme.sunset": "Sunset",
  ...
  "landing.hero.badge": "Everything your feminine routine needs",
  "landing.hero.title1": "Your routine,",
  "landing.hero.title2": "in harmony",
  "landing.hero.sub": "Cycle, agenda, tasks, hair schedule and skin care — organized in one place, fully private.",
  "landing.mod.cycle.t": "Cycle & Diary",
  "landing.mod.cycle.d": "Calendar with phases, predictions and symptoms.",
  "landing.mod.agenda.t": "Agenda",
  "landing.mod.agenda.d": "Events with date, time and place.",
  "landing.mod.tasks.t": "Tasks",
  "landing.mod.tasks.d": "To-dos with priorities and due dates.",
  "landing.mod.hair.t": "Hair schedule",
  "landing.mod.hair.d": "Hydration, nutrition and reconstruction in rhythm.",
  "landing.mod.skincare.t": "Skin care",
  "landing.mod.skincare.d": "AM and PM routine with daily check-in.",
  "landing.mod.privacy.t": "Privacy",
  "landing.mod.privacy.d": "Your data, accessible only by you.",
  "landing.steps.title": "How it works",
  "landing.step1.t": "Create your account",
  "landing.step1.d": "In seconds, with email or Google.",
  "landing.step2.t": "Tell us your rhythm",
  "landing.step2.d": "A few initial questions about your cycle.",
  "landing.step3.t": "Use the buttons",
  "landing.step3.d": "Every area of your routine, one tap away.",
  "landing.final.title": "Start organizing your routine today",
};
