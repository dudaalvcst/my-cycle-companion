  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(40% 60% at 30% 50%, color-mix(in oklch, var(--color-phase-ovulatory) 35%, transparent), transparent), radial-gradient(40% 60% at 70% 40%, color-mix(in oklch, var(--color-phase-luteal) 25%, transparent), transparent? transparent)",
        }}
      />
